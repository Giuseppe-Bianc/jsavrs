...
- **FR-007**: System MUST conservatively preserve all store instructions unless proven to be local-only with no subsequent loads
- **FR-008**: System MUST conservatively preserve all function call instructions unless callee purity can be proven
