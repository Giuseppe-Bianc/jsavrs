...
use crate::utils::get_git_commit_hash;
...
impl fmt::Display for AssemblyFile {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "; Generated on: {}", std::fmt::from_fn(|f| f.write_str(&iso_8601)))?;
        write!(f, "; Generated by: {} {}", clap::crate_name!(), clap::crate_version!())?;
        // Optional Git commit hash
        match get_git_commit_hash() {
            Some(ref hash) => writeln!(f, " Commit SHA: {}", std::fmt::from_fn(|f| f.write_str(hash)))?,
            None => writeln!(f, " Commit SHA: (unknown)")?,
        }
